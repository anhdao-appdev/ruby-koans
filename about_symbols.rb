...
class AboutSymbols < Neo::Koan
  ...
  ## Every time you declare a symbol, it gets added to the list of all symbols, even if only for comparison purposes. 
  ## This compromises the integrity of the test in the future.
